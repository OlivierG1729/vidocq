...
from core.entity_extractor import get_entity_cache
from visualization.graph_builder import build_graph
from visualization.graph_display import display_graph, export_graph_image
from visualization.word_cloud_builder import generate_wordcloud
from lib.indexing import get_index_manager  # lib reste à la racine
# ------------------------------------------------

import sys
from pathlib import Path

# Ajoute le dossier racine (celui qui contient "code" et "lib") au PYTHONPATH
...
def set_cyber_style():
    ...
    <style>
    .stApp {
        background: linear-gradient(to bottom, #002a2d, #d2ac7a);
        color: #00ffcc;
        font-family: 'Courier New', monospace;
    }
    img {
        box-shadow: 0px 30px 80px -10px rgba(255, 200, 160, 0.5);
        border-radius: 10px;
    }
    h1,h2,h3,h4,h5,h6 {
        color: #003300;
